...
<div class="row">
  ...
  <div class="span6">
    <div class="well well-small" id="nuget">
      The YC.QuickGraph.Query library can be <a href="https://nuget.org/packages/YC.QuickGraph.Query">installed from NuGet</a>:
      <pre>PM> Install-Package YC.QuickGraph.Query</pre>
    </div>
  </div>
  <div class="span1"></div>
</div>
